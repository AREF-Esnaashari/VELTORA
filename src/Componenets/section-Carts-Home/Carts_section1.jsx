...
let data = [
  ...
  { id: 2, imgCart: profecis, description: 'بررسی توسط متخصصان' },
  { id: 0, imgCart: electeronic, description: 'تست و تضمین' },
];

export default function Carts_section1() {
  return (
    <div className="container gap-4  -mt-30  h-auto  mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4   justify-items-center ">
      {data.map((carts) => (
