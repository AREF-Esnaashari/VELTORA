export default function ProductsHeader() {
  return (
    <header className="flex flex-col items-center gap-5 pt-12 text-center">
      ...
      <span className="inline-flex items-center gap-2 rounded-full border border-[#EF9F27]/30 bg-[#EF9F27]/10 px-4 py-1.5 text-xs font-medium tracking-tighter text-[#EF9F27] shadow-[0_0_20px_-5px_rgba(239,159,39,0.4)] backdrop-blur-md">
      ...
      <div className="flex items-center justify-center gap-4 sm:gap-6">
        ...
        <h1 className="bg-gradient-to-l from-white  to-[#EF9F27] bg-clip-text text-4xl  whitespace- text-transparent p-3 drop-shadow-lg sm:text-6xl text-2xl text-center font-vazir font-bold uppercase">
          محصولات ما
        </h1>
