    ...
    <section dir="rtl" className="container px-6 md:px-16 py-20">
      ...
      <div className=" container mt-20 flex items-end justify-end">
        <div className="mt-6 text-2xl  max-w-md text-center leading-loose text-[#b5b3ac]">
          <span className="font-bold text-[#EF9F27]">Veltora</span> یک فروشگاه آنلاین است برای کسانی
          که می‌خواهند خرید هوشمندانه کنند. محصولات نو، محصولات استوک باکیفیت، قیمت‌های واقعی، و
          شفافیت کامل — این‌هاست چیزی که <span className="font-bold text-[#EF9F27]">Veltora</span>{' '}
          را متفاوت می‌کند.
        </div>
      </div>
    </section>
